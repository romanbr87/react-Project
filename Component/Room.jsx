...
export default function Room(props) {
    ...
    return (
        <div className='boxShadow' style={{ backgroundColor: props.room.color, border: '5px solid rgb(221,212,220)', borderRadius: '25px', marginLeft: '20%', marginRight: '20%', color: 'black' }}>
            ...
            <h2 style={{ textDecorationLine: 'underline' }}>My device list</h2>
            {
                props.room.products.map((e, i) => {
                    return (
                        ...
                        <h3 className='boxShadow' className="product" style={{ backgroundColor: e.isTurnedOn ? 'green' : 'red' }}
            ...
            <button className='boxShadow' style={{ cursor: 'pointer', borderRadius: '10px', margin: 'auto', marginBottom: '15px', display: show ? 'none' : 'block' }}
